...
\begin{minipage}[t]{0.5\textwidth} 
	...
	{ \fontsize{16}{20} \textcolor{black}{\textbf{\MakeUppercase{[[FULLNAME]]}}}} % First name
	
	\vspace{6pt}
	
	{\Large [[JOBTITLE]]} % Career or current job title
\end{minipage}
\hfill
