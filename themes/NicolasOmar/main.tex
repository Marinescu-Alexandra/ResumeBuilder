...
\begin{document}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{Projects}
            %[[PROJECTS]]
            % \cvevent{Project 1 }{\cvreference{\faGithub}{https://github.com/user/repo}\cvreference{| \faGlobe}{https://project-demo.com/}}{}{}
            % \begin{itemize}
            %     \item Item 1
            %     \item Item 2
            % \end{itemize}
            ...
            % \cvevent{Project 2 }{\cvreference{\faGithub}{https://gitlab.com/user/repo}\cvreference{| \faGlobe}{https://project-demo.com/}}{}{}
            % \begin{itemize}
            %     \item Item 1
            %     \item Item 2
            % \end{itemize}
